...
public class Servlet1 extends HttpServlet {
...

	{
        ...
        // Montar a página dinâmica de confirmação
        out.println("<html>");
        out.println("<head><title>Cadastro de Carro</title></head>");
        out.println("<body>");
        out.println("<h1>Carro cadastrado com sucesso!</h1>");
        out.println("<ul>");
        out.println("<li>Modelo: " + modelo + "</li>");
        out.println("<li>Marca: " + marca + "</li>");
        out.println("<li>Ano: " + anoFabricacao + "</li>");
        out.println("</ul>");
